...
# search_memory_facts lives in the host memory module (agents/memory/updater.py),
# which the pluggable-backends layout removed. Skip until a backend re-exposes it.
pytest.importorskip("deerflow.agents.memory.updater")

from deerflow.agents.memory.storage import FileMemoryStorage, create_empty_memory  # noqa: E402
from deerflow.agents.memory.updater import search_memory_facts  # noqa: E402
