...
# Tool-driven memory mode is built on the host memory module
# (agents/memory/updater.py), which the pluggable-backends layout removed.
# Skip until a backend re-exposes the tool-mode surface.
pytest.importorskip("deerflow.agents.memory.updater")

from deerflow.agents.memory.tools import (  # noqa: E402
    get_memory_tools,
    memory_add_tool,
    memory_delete_tool,
    memory_search_tool,
